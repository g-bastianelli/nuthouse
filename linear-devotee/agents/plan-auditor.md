...
COORDINATION_CONTEXT: <affected peer bodies, contract decisions, live relations and dependency closure | none with reason>
RELEVANT_FILES:
...
7. Apply `${PLUGIN_ROOT}/shared/coordination-review.md` to the plan and supplied peer evidence.
   Missing required peer/closure evidence or an unapplied Linear repair prevents implementation
   readiness. Report the required upstream correction; do not add runtime scheduling rules.
...
COORDINATION_REVIEW: pass | needs_changes
COORDINATION_EVIDENCE: <interactions, decisions, edges or independence reasons, cycle evidence>
