...
| `warden`         | Worktree-scoped workflow profile client plus centralized voice agent. `warden:mode` sets, inspects, or resets `quick` / `standard` / `strict`; `warden:voice` dispatches decorative persona lines and toggles them globally. Domain plugins remain operational without Warden.                                                                                                                                                                                                                                                                                                   | —                                        | `mode`, `voice`                                                                                                                                         | `voice`                                                                                                          | `warden/persona.md`         |
| `git-gremlin`    | Contextual review plus commit + PR drafting with scoped mutation gates. Reads staged diff / git log through subagents, proposes conventional commit messages and PR descriptions, and executes only on approval. It owns no workspace orchestration or branch guard.                                                                                                                                                                                                                                                                                                             | —                                        | `commit`, `pr`, `review`, `review-passes`                                                                                                               | `commit-drafter`, `pr-drafter`, `reviewer`                                                                       | `git-gremlin/persona.md`    |
...
| `monkey-maestro` | One-shot project execution reconciler. Linear stores the verified graph, active control, waivers, and execution receipts; each locked reconciliation reloads Linear/GitHub/Superset, reconstructs exact `taskId` workspaces, and fills bounded concurrency without polling or a private queue. It owns task-linked spawn and the Superset branch guard.                                                                                                                                                                                                                          | PreToolUse (Bash)                        | `start`, `reconcile`, `spawn`, `stop`                                                                                                                   | `project-snapshot-loader`, `runtime-inspector`                                                                   | `monkey-maestro/persona.md` |
