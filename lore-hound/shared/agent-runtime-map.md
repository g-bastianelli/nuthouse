...
| --------------------------- | --------------------------- | ---------------------------- |
| `lore-hound:claim-verifier` | `lore-hound:claim-verifier` | `lore_hound__claim_verifier` |
| `lore-hound:source-fetcher` | `lore-hound:source-fetcher` | `lore_hound__source_fetcher` |
